...
function checkBgImgCookie() {
    ...
    if (bgurl != "") {
        if (bgurl == "https://cdn.defectink.com/images/Sensei_sakura.png" || bgurl == "https://cdn.defectink.com/images/Sensei_2.png" || bgurl == "https://cdn.defectink.com/images/Sensei_3.png" || bgurl == "https://cdn.defectink.com/images/Sensei_4.png" || bgurl == "https://cdn.defectink.com/images/Sensei_5.png") {
            mashiro_global.variables.skinSecter = true;
            mashiro_global.variables.isNight = false;
            $("#night-mode-cover").css("visibility", "hidden");
            $("body").css("background", "url(" + bgurl + ") no-repeat center fixed");
			$("body").css("background-size", "cover");
            $(".blank").css("background-color", "rgba(255,255,255,1)");
            $(".pattern-center").removeClass('pattern-center').addClass('pattern-center-sakura');
            $(".headertop-bar").removeClass('headertop-bar').addClass('headertop-bar-sakura');
        } else if (bgurl == "https://api.defectink.com") {
            mashiro_global.variables.skinSecter = true;
...
$(document).ready(function () {
    function changeBG(tagid, url) {
        $(".skin-menu " + tagid).click(function () {
            ...
            mashiro_global.variables.isNight = false;
            $("#night-mode-cover").css("visibility", "hidden");
            $("body").css("background", "url(" + url + ") no-repeat center fixed");
			$("body").css("background-size", "cover");
            $(".blank").css("background-color", "rgba(255,255,255,1)");
            $(".pattern-center").removeClass('pattern-center').addClass('pattern-center-sakura');
            $(".headertop-bar").removeClass('headertop-bar').addClass('headertop-bar-sakura');
    ...
    changeBG("#sakura-bg", "https://cdn.defectink.com/images/Sensei_sakura.png");
    changeBG("#gribs-bg", "https://cdn.defectink.com/images/Sensei_2.png");
    changeBG("#pixiv-bg", "https://cdn.defectink.com/images/Sensei_3.png");
    changeBG("#KAdots-bg", "https://cdn.defectink.com/images/Sensei_4.png");
    changeBG("#totem-bg", "https://cdn.defectink.com/images/Sensei_5.png");
    changeBGnoTrans("#bing-bg", "https://api.defectink.com/");
    ...
    $(".skin-menu #dark-bg").click(function () {
        mashiro_global.variables.skinSecter = true;
        mashiro_global.variables.isNight = true;
        $("body").css("background-image", "url(https://cdn.defectink.com/images/Sensei_dark.png)");
